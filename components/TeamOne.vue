      ...
      <div class="row">
        <div class="col-xl-3 col-lg-3 col-md-6">
          <div class="team_one_single wow fadeInUp">
            <div class="team_one_image">
              <img src="@/static/images/team/team_1-img-1.jpg" alt="" />
            </div>
        ...
        <div class="col-xl-3 col-lg-3 col-md-6">
          <div class="team_one_single wow fadeInDown">
            <div class="team_one_image">
              <img src="@/static/images/team/team_1-img-2.jpg" alt="" />
            </div>
            <div class="team_one_deatils">
              <p>engenheiro</p>
        ...
        <div class="col-xl-3 col-lg-3 col-md-6">
          <div class="team_one_single wow fadeInUp">
            <div class="team_one_image">
              <img src="@/static/images/team/team_1-img-3.jpg" alt="" />
            </div>
            <div class="team_one_deatils">
              <p>Téc. Agrícola</p>
        ...
        <div class="col-xl-3 col-lg-3 col-md-6">
          <div class="team_one_single wow fadeInDown">
            <div class="team_one_image">
              <img src="@/static/images/team/team_1-img-4.jpg" alt="" />
            </div>
            <div class="team_one_deatils">
              <p>Ass. de Campo</p>
