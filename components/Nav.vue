<template>
  <div class="site-header__header-one-wrap">
    <div class="topbar-one">
      <div
        class="topbar_bg"
        style="background-image: url(/images/shapes/header-bg.png)"
      ></div>
      <div class="container">
        <div class="topbar-one__left">
          <a href="mailto:contato@tripo.com"
            ><span class="icon-message"></span>contato@evoterra.com</a
          >
          <a href="tel:666-999-0000"><span class="icon-phone-call"></span>666 888 0000</a>
        </div>
        <div class="topbar-one__middle">
          <NuxtLink to="login" class="main-nav__logo">
            <img
              src="@/static/images/resources/logo.png"
              class="main-logo"
              alt="Awesome Image"
            />
          </NuxtLink>
        ...
        <div class="container clearfix">
          ...
          <div class="main-nav__main-navigation">
            <ul class="main-nav__navigation-box">
              ...
              <li class="dropdown">
                <nuxt-link to="/servicos">Services</nuxt-link>
                <ul>
