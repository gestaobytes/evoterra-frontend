<template>
  <v-card :title="defineTitleModal" :errorValidation="defineError" border="top">
    <v-card>
      <v-toolbar color="#006E80" dark>
        <table width="100%">
          <tr>
            <td>
      ...
      <v-card-text class="pt-10">
        <v-form @submit.prevent="$emit('save')" enctype="multipart/form-data">
