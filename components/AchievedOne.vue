      ...
      <div class="row">
        <div class="col-xl-6 col-lg-12">
          <div class="achieved_one_left_img">
            <img src="@/static/images/resources/achieved_1-img-1.jpg" alt="Achieved One Image">
          </div>
        </div>
        <div class="col-xl-6 col-lg-12">
          <div class="achieved_one_right-content">
            <div class="achieved_one_right_img">
              <img src="@/static/images/resources/achieved_1-img-2.jpg" alt="Achieved Two Image">
            </div>
            <div class="block-title">
              <p>evoterra Success</p>
              <h3>We Archived</h3>
              <div class="leaf">
