      ...
      <div class="row">
        <div class="col-xl-4 col-lg-4 col-md-6">
          <div class="team_one_single wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
            <div class="team_one_image">
              <img src="@/static/images/team/farmers-1.jpg" alt="">
            </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6">
          <div class="team_one_single wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;">
            <div class="team_one_image">
              <img src="@/static/images/team/farmers-2.jpg" alt="">
            </div>
            <div class="team_one_deatils">
              <p>farmer</p>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6">
          <div class="team_one_single wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
            <div class="team_one_image">
              <img src="@/static/images/team/farmers-3.jpg" alt="">
            </div>
            <div class="team_one_deatils">
              <p>farmer</p>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6">
          <div class="team_one_single wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;">
            <div class="team_one_image">
              <img src="@/static/images/team/farmers-4.jpg" alt="">
            </div>
            <div class="team_one_deatils">
              <p>farmer</p>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6">
          <div class="team_one_single wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
            <div class="team_one_image">
              <img src="@/static/images/team/farmers-5.jpg" alt="">
            </div>
            <div class="team_one_deatils">
              <p>farmer</p>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6">
          <div class="team_one_single wow fadeInDown animated" style="visibility: visible; animation-name: fadeInDown;">
            <div class="team_one_image">
              <img src="@/static/images/team/farmers-6.jpg" alt="">
            </div>
            <div class="team_one_deatils">
              <p>farmer</p>
