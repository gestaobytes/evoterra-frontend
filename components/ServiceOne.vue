      ...
      <div class="row">
        <div class="col-xl-3 col-lg-3 col-md-6">
          <div class="service_1_single wow fadeInUp">
            ...
            <div class="service_1_img">
              <img src="@/static/images/service/service-1-img-1.jpg" alt="Service Image">
              <div class="hover_box">
        ...
        <div class="col-xl-3 col-lg-3 col-md-6">
          <div class="service_1_single wow fadeInUp" data-wow-delay="300ms">
            ...
            <div class="service_1_img">
              <img src="@/static/images/service/service-1-img-2.jpg" alt="Service Image">
              <div class="hover_box">
                <nuxt-link to="/service-detail"><span class="icon-left-arrow"></span></nuxt-link>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-lg-3 col-md-6">
          <div class="service_1_single wow fadeInUp" data-wow-delay="600ms">
            ...
            <div class="service_1_img">
              <img src="@/static/images/service/service-1-img-3.jpg" alt="Service Image">
              <div class="hover_box">
                <nuxt-link to="/service-detail"><span class="icon-left-arrow"></span></nuxt-link>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-lg-3 col-md-6">
          <div class="service_1_single wow fadeInUp" data-wow-delay="900ms">
            ...
            <div class="service_1_img">
              <img src="@/static/images/service/service-1-img-4.jpg" alt="Service Image">
              <div class="hover_box">
                <nuxt-link to="/service-detail"><span class="icon-left-arrow"></span></nuxt-link>
              </div>
            </div>
